...
def inference(net, data_label, use_aux):
    if use_aux:
        ...
        img, cls_label = img.cuda(), cls_label.float().cuda()
        cls_out = net(img)
...
if __name__ == "__main__":
    ...
    net = parsingNet(pretrained = True, backbone=cfg.backbone,cls_dim = (cfg.num_lanes,cls_num_per_lane,cfg.griding_num),use_aux=cfg.use_aux).cuda()
